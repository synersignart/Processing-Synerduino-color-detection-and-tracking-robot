...
//video = new Capture(this, 640, 480, 0);//Access your webcam by default
//video = new Capture(this, 640, 480, cameras[0]);//Example: if you want to access an external camera
video = new Capture(this, 640, 480, cameras[1]);//Example: if you want to access an external camera
...
arduinoPort = new Arduino(this, lines[0], 57600);
arduinoPort.pinMode(2, Arduino.SERVO);    // Pin 11 conected a IN4
arduinoPort.pinMode(3, Arduino.SERVO);
arduinoPort.pinMode(4, Arduino.SERVO);
...
void draw() {
  ...
  //arduinoPort.servoWrite(2, constrain(Trims - Axis / Pin, 0, streght));//X-Axis
    arduinoPort.servoWrite(2, constrain(240 - r.x / 2, 0, 180));//X-Axis
    arduinoPort.servoWrite(3, constrain(160 - r.y / 3, 0, 180));//Y-Axis
    arduinoPort.servoWrite(4, constrain(100 - r.width / 4, 0, 180));//Z-Axis
  }
} 
//////////////A very Simple UI////////////////////
////////////////SLIDER BARS//////////////////////
